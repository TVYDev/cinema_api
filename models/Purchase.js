...
purchaseSchema.pre('save', async function (next) {
  ...
  const existingNumberTotalTickets =
    existingPurchases.length > 0 ? existingPurchases[0].numberTotalTickets : 0;
  ...
  if (
    ...
    return next(
      new ErrorResponse('Not enough remaining seats in this showtime', 400)
    );
  }
...
exports.STATUS_INITIATED = STATUS_INITIATED;
